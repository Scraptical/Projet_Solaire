...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(celcius, 6, 4, 1, 1);
        ...
        gridLayout->addWidget(lcdBattery, 9, 0, 1, 1);

        labelTemp = new QLabel(centralwidget);
        labelTemp->setObjectName("labelTemp");

        gridLayout->addWidget(labelTemp, 4, 3, 1, 1);
        ...
        gridLayout->addWidget(lcdPower, 6, 0, 1, 1);

        lcdTemp = new QLCDNumber(centralwidget);
        lcdTemp->setObjectName("lcdTemp");

        gridLayout->addWidget(lcdTemp, 6, 3, 1, 1);
        ...
        gridLayout->addWidget(pourcent, 9, 1, 1, 1);

        labelBattery = new QLabel(centralwidget);
        labelBattery->setObjectName("labelBattery");

        gridLayout->addWidget(labelBattery, 8, 0, 1, 1);
